...
function Navbar({isAuth}) {
  ...
  const [sticky, setSticky] = useState(false); /* SHADOW WITH STICKY HEADER */
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 0) {
        setSticky(true);
    ...
    sticky?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out": ""
        ...
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer">StudyHive</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className="">
              ...
              <a className="bg-yellow-400 text-white font-bold p-3 rounded-md hover:bg-yellow-500 duration-300 cursor-pointer">
                Account
              </a>
              </Link>) :
              (<Link to='/login'>
